...
namespace ToolBox
{
    public static class RectExtensions
    {
        ...
        public static Vector2 GetPosition(this Rect src, float x, float y)
        {
            float _x = Mathf.LerpUnclamped(src.xMin, src.xMax, x);
            float _y = Mathf.LerpUnclamped(src.yMin, src.yMax, y);
