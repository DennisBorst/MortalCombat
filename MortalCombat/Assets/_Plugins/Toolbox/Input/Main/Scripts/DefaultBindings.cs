...
namespace ToolBox.Input
{
    public static class DefaultBindings
    {
        ...
        public static InputBinding[] bindings = new[]
        {
            ...
            new InputBinding {Player = 0, Name = "Left",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.LeftArrow.ToString()},
            new InputBinding {Player = 0, Name = "Right",   DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.RightArrow.ToString()},
            new InputBinding {Player = 0, Name = "Up",      DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.UpArrow.ToString()},
            new InputBinding {Player = 0, Name = "Down",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.DownArrow.ToString()},
            new InputBinding {Player = 0, Name = "Back",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.Backspace.ToString()},
            new InputBinding {Player = 0, Name = "Confirm", DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.Return.ToString()},
            new InputBinding {Player = 0, Name = "Jump",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.Keypad0.ToString()},
            new InputBinding {Player = 0, Name = "Jump",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.UpArrow.ToString()},
            new InputBinding {Player = 0, Name = "Throw",   DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.Keypad2.ToString()},
            new InputBinding {Player = 0, Name = "Punch",   DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.Keypad1.ToString()},
            ...
            new InputBinding {Player = 1, Name = "Left",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.A.ToString()},
            new InputBinding {Player = 1, Name = "Right",   DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.D.ToString()},
            new InputBinding {Player = 1, Name = "Up",      DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.W.ToString()},
            new InputBinding {Player = 1, Name = "Down",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.S.ToString()},
            new InputBinding {Player = 1, Name = "Jump",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.F.ToString()},
            new InputBinding {Player = 1, Name = "Jump",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.W.ToString()},
            new InputBinding {Player = 1, Name = "Throw",   DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.H.ToString()},
            new InputBinding {Player = 1, Name = "Punch",   DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.G.ToString()},
            
            new InputBinding {Player = 1, Name = "Back",    DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.G.ToString()},
            new InputBinding {Player = 1, Name = "Confirm", DeviceType = ControllerType.Keyboard, DeviceIndex = 0, DeviceInputName = KeyCode.F.ToString()},
