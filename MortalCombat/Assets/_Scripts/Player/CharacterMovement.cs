...
namespace MortalCombat
{
    public class CharacterMovement : DependencyBehavior
    {
        ...
        [SerializeField] private float movementSpeed = 7.5f;          // Amount of maxSpeed applied to crouching movement. 1 = 100%
        ...
        public void Move(float move, bool jump)
        {
            if (m_Grounded || m_AirControl)
            {
                ...
                Vector3 targetVelocity = new Vector2(move * movementSpeed, m_rb.velocity.y);
